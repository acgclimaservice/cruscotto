...
* 4\. Le liste documenti dei ddt in e dei ddt out devono essere ordinate di default per numero documento in ordine crescente. Implementare un controllo per prevenire "buchi" nella numerazione sequenziale. **FATTO** ✅ *19:01 24-08-2025*
  - Modificato ordinamento DDT IN e DDT OUT per numero documento crescente
  - Implementata funzione verifica_buchi_numerazione() per controllo sequenziale
