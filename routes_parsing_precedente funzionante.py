...
def parse_pdf():
    ...
    try:
        ...
        try:
            ...
            # Usa parse_ddt_with_ai invece di parse_with_ai
            result = parser.parse_ddt_with_ai(temp_path)
            ...
            if result and result.get('success'):
                ...
                return jsonify({
                    'success': True,
                    'data': {
                        'fornitore': result.get('fornitore', ''),
                        'numero_ddt': result.get('numero_documento', ''),
                        'data_ddt': result.get('data_documento', ''),
